...
{
    public class ReportQualificationDataCollection : ObservableCollection<ReportQualificationData>
    {
        public ReportQualificationDataCollection()
        {

        }


        public bool GenerateQualificationData(string regNo)
        {
            DataTable dtTable = ManagerQueryService.Current.QueryServiceQualificationRegistration.ReportQualificationData(regNo);
            ...
            if (dtTable != null && dtTable.Rows.Count > 0)
            {
                try
                {
                    ...
                    {
                        ReportQualificationData testData = new ReportQualificationData();
                        ...
                        testData.CORRECTED_ABSORBANCE = dtTable.Rows[i]["CORRECTED_ABSORBANCE"].ToString();
                        ...
                        testData.TOLUENE_CONTENT = dtTable.Rows[i]["TOLUENE_CONTENT"].ToString();
                        testData.TARGET_ABSORBANCE_MIN = dtTable.Rows[i]["TARGET_ABSORBANCE_MIN"].ToString();
                        testData.TARGET_ABSORBANCE_MAX = dtTable.Rows[i]["TARGET_ABSORBANCE_MAX"].ToString();
    ...
    public class ReportQualificationData : BaseModel
    {
        public ReportQualificationData()
        {
        ...
        public string CORRECTED_ABSORBANCE { get; set; }
        public string MINIMUM_TRANSMISSION { get; set; }        
        public string MINIMUM_TRANSMISSION_SECOND { get; set; }

        public string TOLUENE_CONTENT { get; set; }
        public string TARGET_ABSORBANCE_MIN { get; set; }
        public string TARGET_ABSORBANCE_MAX { get; set; }
