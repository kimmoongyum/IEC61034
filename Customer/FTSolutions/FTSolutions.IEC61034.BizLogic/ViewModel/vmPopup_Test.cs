...
namespace FTSolutions.IEC61034.BizLogic.ViewModel
{
    public class vmPopup_Test : BaseIEC61034ViewModel
    {
        ...
        {
            get { return _testItem_Test; }
            set
            {
                if (this._testItem_Test != value)
                {
                    this._testItem_Test = value;
                    this.RaisePropertyChanged(nameof(TestItem_Test));
                }
            }
        }
        ...
        public override void VMLoaded()
        {
            ...
            if(SessionManager.Current.IEC61034_DataSetTest.RegistrationInfo.CABLE_TYPE.Equals("ROUND", StringComparison.OrdinalIgnoreCase)) {
            ...
            this.TestItem_Test.InitializeData(StandardType.IEC61034);
        ...
        protected override void ExecuteNextClick(object obj)
        {
            ...
            if (this.TestItem_Test.Standard == null || this.TestItem_Test.Standard.SeriesTransmission == null ||
                this.TestItem_Test.Standard.SeriesTransmission.SeriesCollection.Count < 1)
            {
                return;
            }

            this.SESSION_MANAGER.IEC61034_DataSetTest.Info_Test.CopyValueFrom(this.TestItem_Test);

            string targetMenu = IEC61034Const.MENU_TEST_SUMMARY_KEY;
        ...
        {
            return this.TestItem_Test.Standard != null && this.TestItem_Test.Standard.SeriesTransmission != null && 
                this.TestItem_Test.Standard.SeriesTransmission.SeriesCollection.Count > 0;
        }
        ...
        public void ExecuteTickTimerCommand(object obj)
        {
            ...
            {
                this.TestItem_Test.Standard.CheckTestData();                

                int totalSeconds = Convert.ToInt32(((DependencyPropertyChangedEventArgs)obj).NewValue);

                while (this.TestItem_Test.Standard.SeriesTransmission.GetIndex - 1 < totalSeconds)
                {
#if IS_LOCAL
                    if (this.StopTimer)
                    {
        ...
        {            
            ...
            this.TestItem_Test.StartTest();

            this.TestItem_Test.Standard.StartChamberTemperature = DEVICE_MANAGER.AnalogInput.ChamberTemperature;
        }
        ...
        public void ExecuteStopCommand(object obj)
        {
            ...
            this.TestItem_Test.Standard.FinishTimeSecond = this.TestItem_Test.Standard.SeriesTransmission.SeriesCollection.Count - 1;
            this.TestItem_Test.StopTest();
        }
