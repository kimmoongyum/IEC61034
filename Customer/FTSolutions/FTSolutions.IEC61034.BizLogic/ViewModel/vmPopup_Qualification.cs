    ...
    public class vmPopup_Qualification : BaseIEC61034ViewModel
    {
        ...
        public void ExecuteChangeStopConditionCommand(object obj)
        {
            if (obj != null)
            {
                ...
                {
                    this.TestItem_Qualification.CurrentStopTime = IEC61034Const.DEFAULT_MANUAL_STOP_TIME;
                    this.TestItem_Qualification.Standard.IsAutoStop = false;
                    this.TestItem_Qualification.Standard.IsManualStop = true;
                }
                else
                {
                    this.TestItem_Qualification.Standard.IsAutoStop = true;
        ...
        {
            //this.TestItem_Qualification.IsFlameout = true;

            if (this.TestItem_Qualification.Standard.SeriesTransmission.SeriesCollection.Count - 1 < 0)
            {
                //this.TestItem_Qualification.FlameoutSecond = 0;
                this.TestItem_Qualification.FlameoutTime = 0;
            }
            else
            {
                ...
                this.TestItem_Qualification.FlameoutTime = this.TestItem_Qualification.Standard.SeriesTransmission.SeriesCollection.Count - 1;
            }
